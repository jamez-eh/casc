...
Each `casc` object can be accessed via `casc_list$casc_x`, where x is the index of the corresponding clustering in the list provided to `cascer`.
...
test_casc_list <- cascer(sce_sim, list(sce_sim$sc3_2_clusters, sce_sim$sc3_3_clusters, sce_sim$sc3_5_clusters, sce_sim$sc3_8_clusters, sce_sim$sc3_9_clusters, sce_sim$sc3_10_clusters, sce_sim$sc3_11_clusters, sce_sim$sc3_12_clusters, sce_sim$sc3_15_clusters), alpha =0.5)
...
multROCPlot(test_casc_list$casc_1)
multROCPlot(test_casc_list$casc_2)
casc::multROCPlot(test_casc_list$casc_3)
casc::multROCPlot(test_casc_list$casc_4)
casc::multROCPlot(test_casc_list$casc_5)
casc::multROCPlot(test_casc_list$casc_6)
casc::multROCPlot(test_casc_list$casc_7)
casc::multROCPlot(test_casc_list$casc_8)
casc::multROCPlot(test_casc_list$casc_9)
```
